...
ENT.Model = "models/polaroid/frame.mdl"
ENT.InitPhys = false
...
hook.Add("playerBoughtCustomEntity", "incredible-gmod.ru/polaroid", function(ply, _, ent)
...
hook.Add("playerBoughtCustomEntity", "incredible-gmod.ru/polaroid/nophys", function(ply, _, ent)
