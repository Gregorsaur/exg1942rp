...
ITEM.name = "Maschinenpistole 34"
ITEM.desc = "An outdated weapon, mainly used by local police forces and the Waffen-SS."
ITEM.model = "models/khrcw2/doipack/w_mp34.mdl"
ITEM.class = "doi_ws_atow_mp34"
