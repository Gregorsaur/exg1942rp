PLUGIN = PLUGIN or {}
PLUGIN.name = "Banking Sub-Module"
PLUGIN.desc = "A Banking System Sub Module"
...
BANKCONF.premiumSettings = {
    upRunAmount = 550,
    loanInter = 0.77, -- premium account loan interest
