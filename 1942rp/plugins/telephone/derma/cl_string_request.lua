function String_Request(name, onRun, onCancel, okBtnText)
  ...
  function bb.pop:close()
    local popout = Derma_Anim("popout", self, function(pnl,anim,dt,data)
  ...
  local pop = Derma_Anim("pop", bb.pop, function(pnl,anim,dt,data)
  ...
  timer.Simple(0.2, function()
    ...
    bb.pop.name:SetFont("nutSmallFont")
    ...
    bb.pop.ok:SetFont("nutSmallFont")
    ...
    bb.pop.cancel:SetFont("nutSmallFont")
