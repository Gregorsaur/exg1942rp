PLUGIN.name = "Server Performance Fixer - NutScript.Net"
PLUGIN.author = "Haha yeah man / The Teflon Don "
PLUGIN.desc = "A script that does things and stuff to make fps better. | Credits to santosrp for the stuff. I just made it work with NutScript"
