...
PLUGIN.name = "Wolf Derma Library"
PLUGIN.author = "Robert Bearson // Barata"
PLUGIN.desc = "Derma Library for MITHC"

WB = {}
nut.util.include("sh_printer.lua")
nut.util.include("cl_panel_specific.lua")
nut.util.include("cl_web_image.lua")
nut.util.include("sh_group.lua")

nut.util.include("cl_anims.lua")
...
--Returns a vector and angle using the `getpos` command in-game
