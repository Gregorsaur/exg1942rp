...
ENT.Purpose					  = "Use this distillery to brew beer."
ENT.Model             		  = "models/mosi/fallout4/furniture/workstations/chemistrystation02.mdl"
ENT.InvWidth          		  = 7
ENT.InvHeight          		  = 12
