...
ENT.PrintName           	  = "Tobacco Bench"
ENT.Purpose					  = "Use this table to make Cigarettes."
ENT.Model               	  = "models/comradebear/props/workstation/workstation_workbench.mdl"
ENT.InvWidth            	  = 9
ENT.InvHeight           	  = 8
